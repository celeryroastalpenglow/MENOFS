...
### Carbon constraint
The model does not have access to any negative emission technologies, like bioenergy carbon capture and storage (BECCS) or direct air capture (DAC), and is constrained to emit on average 2gCO<sub>2</sub>/kWh generated, which is meant to represent the contribution of the electricity system in a net-zero energy system [(The Climate Change Committee, 2020)](https://www.h2knowledgecentre.com/content/government615).
